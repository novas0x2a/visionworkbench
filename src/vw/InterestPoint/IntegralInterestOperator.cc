...
const double vw::ip::OBALoGInterestOperator::SCALE_LOG_SIGMA[10] = {1.2, 1.5, 1.875, 2.34375, 2.9296875, 3.662109, 4.577636, 5.722046, 7.152557, 8.9406967};
const int vw::ip::OBALoGInterestOperator::SCALE_BOX_WIDTH[10][6] =
	{{11,7,5,3,3,1},     // S 0
	 {13,9,7,5,3,1},     // S 1
	 {17,11,9,5,5,3},    // S 2
	 {21,13,11,7,7,3},   // S 3
	 ...
	 {3,3,3,3,3,3},      // S 8
	 {3,3,3,3,3,3}};     // S 9
const int vw::ip::OBALoGInterestOperator::SCALE_BOX_HEIGHT[10][6] =
	{{11,5,7,3,1,3},     // S 0
	 {13,7,9,1,3,5},     // S 1
	 {17,9,11,5,3,5},    // S 2
	 {21,11,13,3,7,7},   // S 3
	 ...
	 {3,3,3,3,3,3},      // S 8
	 {3,3,3,3,3,3}};     // S 9
const double vw::ip::OBALoGInterestOperator::SCALE_BOX_WEIGHT[10][6] =
